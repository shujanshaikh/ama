...
verify_installation() {
    ...
    if command_exists ama; then
        success "AMA CLI installed successfully!"
        echo ""
        echo -e "${GREEN}${BOLD}Installation complete!${NC}"
        echo ""
        info "Get started with:"
        echo ""
        echo -e "    ${CYAN}ama --help${NC}        Show available commands"
        echo -e "    ${CYAN}ama${NC}               Start the agent"
        echo ""
        return 0
    elif command_exists ama-agent; then
        success "AMA CLI installed successfully!"
        echo ""
        echo -e "${GREEN}${BOLD}Installation complete!${NC}"
        echo ""
        info "Get started with:"
        echo ""
        echo -e "    ${CYAN}ama-agent --help${NC}  Show available commands"
        echo -e "    ${CYAN}ama-agent${NC}         Start the agent"
        echo ""
        return 0
    else
