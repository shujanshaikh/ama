...
function Chat() {
    ...
    useEffect(() => {
        if (
            ...
            userStream.rpc
                ...
                .catch((err) => {
                    console.warn(
                        "Failed to register project with daemon:",
                        err,
                    );
                });
        }
        ...
        () =>
            new DefaultChatTransport({
                ...
                prepareSendMessagesRequest({ messages, body }) {
                    ...
                    const isExecutePlan =
                        messageText.toLowerCase().trim() === "execute" ||
                        messageText.toLowerCase().trim() === "execute plan";
    ...
    useEffect(() => {
        ...
        if (hasInitializedRef.current && currentChatIdRef.current === _chatId)
            return;
